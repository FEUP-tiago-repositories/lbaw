...
```
cd existing_repo
git remote add origin https://gitlab.up.pt/lbaw/lbaw2526/lbaw25122.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.up.pt/lbaw/lbaw2526/lbaw25122/-/settings/integrations)
