...
<head>
    ...
    <title>Admin Dashboard - {{ config('app.name', 'SportsHub') }}</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <a href="{{ route('admin.users.index') }}"
                class="bg-white rounded-lg shadow-sm p-6 group border border-gray-300 hover:border-2 hover:border-emerald-700 transition-colors">
                <div class="bg-green-50 w-12 h-12 rounded-lg flex items-center justify-center mb-6">
