    ...
    <div class="h-[85dvh] flex items-center justify-center p-4">
        <div class="text-xl bg-white rounded-lg shadow-xl max-w-md w-full">
            ...
            <div class="p-12 text-center">
                ...
                <h3 class="font-bold text-gray-900 mb-2">Payment confirmed!</h3>
                <p class="text-gray-600 mb-8">Your reservation has been successfully confirmed.</p>

                <a href="{{ route('bookings.index', ['user_id' => auth()->id()]) }}"
                   class="text-lg inline-block px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition">
                    See reservations
                </a>
            </div>
        </div>
